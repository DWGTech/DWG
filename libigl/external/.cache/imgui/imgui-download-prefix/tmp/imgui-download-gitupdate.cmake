...
execute_process(
  COMMAND "C:/Program Files/Git/mingw64/bin/git.exe" show-ref "v1.76"
  WORKING_DIRECTORY "C:/dev/libigl/cmake/../external/imgui"
...
if("${show_ref_output}" MATCHES "refs/remotes/v1.76")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "v1.76")
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: 'C:/dev/libigl/cmake/../external/imgui'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/dev/libigl/cmake/../external/imgui'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
