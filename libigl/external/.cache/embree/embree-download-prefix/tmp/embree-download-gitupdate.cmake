...
execute_process(
  COMMAND "C:/Program Files/Git/mingw64/bin/git.exe" show-ref "v3.5.2"
  WORKING_DIRECTORY "C:/dev/libigl/cmake/../external/embree"
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: 'C:/dev/libigl/cmake/../external/embree'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/dev/libigl/cmake/../external/embree'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
