...
execute_process(
  COMMAND "C:/Program Files/Git/mingw64/bin/git.exe" show-ref "1f8fab844173890f1e326d93c9ca6c50dad1c6b2"
  WORKING_DIRECTORY "C:/dev/libigl/cmake/../external/../tutorial/data"
...
if("${show_ref_output}" MATCHES "refs/remotes/1f8fab844173890f1e326d93c9ca6c50dad1c6b2")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "1f8fab844173890f1e326d93c9ca6c50dad1c6b2")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "1f8fab844173890f1e326d93c9ca6c50dad1c6b2")
endif()
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: 'C:/dev/libigl/cmake/../external/../tutorial/data'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/dev/libigl/cmake/../external/../tutorial/data'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
