...
execute_process(
  COMMAND "C:/Program Files/Git/mingw64/bin/git.exe" show-ref "5a70326574b34d6a51d9eaf6a9f78813657ee108"
  WORKING_DIRECTORY "C:/dev/libigl/cmake/../external/triangle"
...
if("${show_ref_output}" MATCHES "refs/remotes/5a70326574b34d6a51d9eaf6a9f78813657ee108")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "5a70326574b34d6a51d9eaf6a9f78813657ee108")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "5a70326574b34d6a51d9eaf6a9f78813657ee108")
endif()
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: 'C:/dev/libigl/cmake/../external/triangle'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/dev/libigl/cmake/../external/triangle'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
