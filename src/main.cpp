...
{
    std::string point_cloud_path = "E:/iterative-main/iterative-main/data";
    std::string file_name = "dino_10w_0.75.xyz";
    std::string out_mesh_path = "E:/DWG_Web/DWG_VSIG/mesh";
    int input_normal = 3;
    int grid_reso = 400;
    int final_reso = 500;
    int kw = 6;
